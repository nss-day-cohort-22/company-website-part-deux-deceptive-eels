const spoolOne = {
    ...
    "Image":`<img src="spools/img/pool1.jpg" width="90%" height="500" onMouseover="src='spools/img/pool2.jpg'" onMouseout="src='spools/img/pool1.jpg'">`
}
...
const spoolTwo = {
    ...
    "Image":`<img src="spools/img/pool3.jpg" width="90%" height="500" onMouseover="src='spools/img/pool4.jpg'" onMouseout="src='spools/img/pool3.jpg'">`
}
...
const spoolThree = {
    ...
    "Image":`<img src="spools/img/pool5.jpg" width="90%" height="500" onMouseover="src='spools/img/pool6.jpg'" onMouseout="src='spools/img/pool5.jpg'">`
}
...
const spoolFour = {
    ...
    "Image":`<img src="spools/img/pool7.jpg" width="90%" height="500" onMouseover="src='spools/img/pool8.jpg'" onMouseout="src='spools/img/pool7.jpg'">`
}
